...
class ActivityLog(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey("user.id"), nullable=False)
    action = db.Column(db.String(255), nullable=False)  # e.g., 'Generated Worksheet', 'Viewed Flashcards'
    resource_type = db.Column(db.String(50), nullable=False)  # 'Worksheet' or 'Flashcard'
    resource_name = db.Column(db.String(255), nullable=True)  # Topic Name
    date = db.Column(db.DateTime, default=datetime.utcnow)
    source = db.Column(db.String(50), default="AI Generated")  # AI or Predefined Database
...
def log_activity():
    ...
    action = data.get("action")  # e.g., 'Generated Worksheet', 'Downloaded Flashcards'
    resource_type = data.get("resource_type")  # 'Worksheet' or 'Flashcard'
    resource_name = data.get("resource_name")  # Topic Name
